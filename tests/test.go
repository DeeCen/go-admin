...
func Cleaner(config config.DatabaseList) {
    ...
    var insertData = map[string][]dialect.H{
        "goadmin_user": {
            {"username": "admin", "name": "admin", "password": "$2a$10$TEDU/aUxLkr2wCxGxI62/.yOtzrzfv426DLLdyha9H2GpWRggB0di", "rememberToken": "tlNcBVK9AvfYH7WEnwB1RKvocJu8FfRy4um3DJtwdHuJy0dwFsLOgAc0xUfh"},
            {"username": "operator", "name": "operator", "password": "$2a$10$rVqkOzHjN2MdlEprRflb1eGP0oZXuSrbJLOmJagFsCd81YZm0bsh.", "rememberToken": "tlNcBVK9AvfYH7WEnwB1RKvocJu8FfRy4um3DJtwdHuJy0dwFsLOgAc0xUfh"},
        },
        "goadmin_role": {
        ...
        "goadmin_menu": {
            {"parentId": 0, "type": 1, "order": 2, "title": "Admin", "icon": "fa-tasks", "uri": ""},
            {"parentId": 1, "type": 1, "order": 2, "title": "Users", "icon": "fa-users", "uri": "/info/manager"},
            //{"parentId": 0, "type": 1, "order": 3, "title": "test2 menu", "icon": "fa-angellist", "uri": "/example/test"},
            //{"parentId": 1, "type": 1, "order": 4, "title": "Permission", "icon": "fa-ban", "uri": "/info/permission"},
            {"parentId": 1, "type": 1, "order": 5, "title": "Menu", "icon": "fa-bars", "uri": "/menu"},
            //{"parentId": 1, "type": 1, "order": 6, "title": "Operation log", "icon": "fa-history", "uri": "/info/op"},
            {"parentId": 0, "type": 1, "order": 1, "title": "Dashboard", "icon": "fa-bar-chart", "uri": "/"},
            {"parentId": 0, "type": 1, "order": 7, "title": "User", "icon": "fa-users", "uri": "/info/user"},
        },
        "goadmin_role_user": {
            {"userId": 1, "roleId": 1},
            {"userId": 2, "roleId": 2},
        ...
        /*"goadmin_user_permissions": {
            {"userId": 1, "permission_id": 1},
            {"userId": 2, "permission_id": 2},
        },*/
        /*"goadmin_role_permissions": {
            {"roleId": 1, "permission_id": 1},
            {"roleId": 1, "permission_id": 2},
            {"roleId": 2, "permission_id": 2},
        },*/
        "goadmin_role_menu": {
            {"roleId": 1, "menuId": 1},
            {"roleId": 1, "menuId": 7},
