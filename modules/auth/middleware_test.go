...
func TestCheckPermissions(t *testing.T) {
    ...
    assert.Equal(t, CheckPermissions(user, "/admin/info/user", "get", param), true)
    assert.Equal(t, CheckPermissions(user, "/admin/show/normal_manager?_key_edit_pk=2&_cols=id,roles,createAt,updateAt", "get", param), true)
    assert.Equal(t, CheckPermissions(user, "/admin/show/normal_manager?_key_edit_pk=2", "get", param), true)
    assert.Equal(t, CheckPermissions(user, "/admin/show/normal_manager?_key_edit_pk=3&_cols=id,roles,createAt,updateAt", "get", param), false)
    assert.Equal(t, CheckPermissions(user, "/admin/show/normal_manager?_cols=id,roles,createAt,updateAt&id=3", "get", param), false)
    ...
    assert.Equal(t, CheckPermissions(user, "/admin/info/user_list?_key_edit_pk=3&user_type=20", "get", param), true)
