...
type FieldFilterFn func(f FieldModel) interface{}

// PostFieldFilterFn is filter function of data.
type PostFieldFilterFn func(post PostFieldModel) interface{}
...
func (f FieldList) GetTheadAndFilterForm(info TableInfo, params parameter.Parameters, columns []string,
    ...
    for _, field := range f {
        ...
        thead = append(thead, TheadItem{
            ...
            HideForExport: field.HideForExport,
...
func (def *NilAction) SetBtnId(_ string)            {}
func (def *NilAction) SetBtnData(_ interface{})     {}
...
func (def *DefaultAction) SetBtnId(_ string)            {}
func (def *DefaultAction) SetBtnData(_ interface{})     {}
...
func (i *InfoPanel) AddColumnButtons(head string, buttons ...Button) *InfoPanel {
    ...
    for _, btn := range buttons {
        btn.GetAction().SetBtnId("." + btn.IdStr())
    ...
    i.FooterHtml += "<script>" + template.HTML(ParseTableDataTmpl(js)) + "</script>"
    i.FieldList = append(i.FieldList, Field{
        Head:     head,
        Field:    head,
        TypeName: db.Varchar,
...
func (i *InfoPanel) FieldHideForExport() *InfoPanel {
    i.FieldList[i.curFieldListIndex].HideForExport = true
    return i
}
