...
func GetGoadminSuperUsersTable(ctx *context.Context) table.Table {
    ...
    info.AddField("Remember_token", "rememberToken", db.Varchar)
    info.AddField("createAt", "createAt", db.Timestamp)
    info.AddField("updateAt", "updateAt", db.Timestamp)
    ...
    formList.AddField("Remember_token", "rememberToken", db.Varchar, form.Text)
    formList.AddField("createAt", "createAt", db.Timestamp, form.Datetime)
    formList.AddField("updateAt", "updateAt", db.Timestamp, form.Datetime)
